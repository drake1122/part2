                ...
                <tbody>
                    ...
                    <tr id="it_option_<?php echo $key; ?>">
                        <th>
                            ...
                            <input type="hidden" name="opt_id[]" value="<?php echo get_text($option['opt_id']); ?>">
                        </th>
                        <td>
                            <div class="opt-cell"><?php echo get_text($option['opt_1']); if ($option['opt_2_len']) echo ' <small>&gt;</small> '.get_text($option['opt_2']); if ($option['opt_3_len']) echo ' <small>&gt;</small> '.get_text($option['opt_3']); ?></div>
                        </td>
                        <td>
