...
/*----- Main Order -----*/
.order-wrap {position:relative;overflow:hidden;border-radius:7px;border:1px solid var(--tbc-primary)}
...
.personal-order-wrap {position:relative;overflow:hidden;margin-bottom:20px;border-radius:7px;border:1px solid var(--tbc-primary)}
...
@media (max-width:1399px) {
    .order-wrap {border-bottom-left-radius:0;border-bottom-right-radius:0}
    .personal-order-wrap {border-top:0;border-top-left-radius:0;border-top-right-radius:0}
...
/*----- Latest -----*/
.main-latest-wrap {position:relative;overflow:hidden;padding:10px;height:300px;border-radius:7px;border:1px solid var(--tbc-primary)}
...
.main-latest-link .main-latest-cont .member-point-info {position:absolute;top:2px;right:0;min-width:60px;background:#45454a;color:#fff;padding:3px 5px;font-size:10px;line-height:1;text-align:right;border-radius:3px}
...
/*----- Site Chart -----*/
.site-chart-wrap {position:relative;min-height:300px;border-radius:7px;border:1px solid var(--tbc-primary)}
...
/*----- Member Rank Chart -----*/
.member-chart-wrap {position:relative;padding:15px;height:300px;border-radius:7px;border:1px solid var(--tbc-primary)}
...
.member-chart-wrap .member-rank-list .rank-num {display:inline-block;position:absolute;top:1px;left:0;width:30px;height:22px;line-height:22px;text-align:center;color:#fff;font-size:.75rem;background:#45454a;margin-right:5px;border-radius:3px}
                    ...
                    <a href="<?php echo $status['href']; ?>">
                        <div class="order-box-in">
                            <h3>
                                ...
                                <?php echo number_format($status['count'] ? $status['count'] : 0); ?>
                            </h3>
                            <p>
                            ...
                            <span>
                                <?php echo number_format($status['price'] ? $status['price'] : 0); ?> 원
                            </span>
                        </div>
                    </a>
                </div>
