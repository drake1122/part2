...
<style>
.member-signature {position:relative;margin:30px 0;border:1px solid #d5d5d5;border-radius:7px;font-size:.9375rem;height:300px}
...
.member-signature .signature-info .bl-photo {display:inline-block;margin-right:2px}
.member-signature .signature-info .bl-photo img {width:19px;height:19px}
...
.member-signature-latest .nav-tabs li:last-child a {border-right:0;border-top-right-radius:7px}
...
@media (max-width:767px) {
    ...
    .member-signature-latest .nav-tabs li:last-child a {border-top-right-radius:0}
}
</style>
