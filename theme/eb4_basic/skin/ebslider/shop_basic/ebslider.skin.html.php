...
.ebs-shop-basic-in .swiper-slide img {display:block;width:90%;height:100%;object-fit:cover;margin:0 auto;}
...
.ebs-shop-basic-in .swiper-button-next:before {right:10px;border-right:1px solid #000;border-top:1px solid #000}
.ebs-shop-basic-in .swiper-button-prev:before {left:10px;border-left:1px solid #000;border-bottom:1px solid #000}
.ebs-shop-basic-in .swiper-button-next:after, .ebs-shop-basic-in .swiper-button-prev:after {content:"";display:block;position:absolute;top:50%;width:0;height:1px;background:#000;-webkit-transition:all 0.4s ease-in-out;-moz-transition:all 0.4s ease-in-out;-o-transition:all 0.4s ease-in-out;transition:all 0.4s ease-in-out}
