...
.shop-wishlist .wishlist-box-in {position:relative;border:1px solid #e5e5e5;border-radius:7px;padding:10px;-webkit-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
.shop-wishlist .wishlist-box-in:hover {border-color:#757575}
.shop-wishlist .wishlist-box .wishlist-img {margin-bottom:15px}
.shop-wishlist .wishlist-box .wishlist-img img {border-radius:5px;display:block;max-width:100%;height:auto}
...
.shop-wishlist .wishlist-bottom .wishlist-del-btn {position:absolute;top:0;right:0;width:30px;height:30px;line-height:30px;text-align:center;color:#fff;background:#4B4B4D;border-radius:3px}
...
.shop-wishlist .wishlist-act-btn .btn-e {min-width:140px}
...
<div class="shop-wishlist">
    ...
    <div class="wishlist-act-btn">
        <button type="submit" class="btn-e btn-e-brd btn-e-xl btn-e-dark" onclick="return fwishlist_check(document.fwishlist,'');">장바구니 담기</button>
        <button type="submit" class="btn-e btn-e-xl btn-e-navy" onclick="return fwishlist_check(document.fwishlist,'direct_buy');">주문하기</button>
    </div>
    </form>
</div>
<?php /* ---------- 위시리스트 끝 ---------- */ ?>
