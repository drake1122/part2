...
<div class="shop-personalpay-form">
    ...
    <div class="personalpay-form-wrap">
        ...
        <div class="payment-select-wrap">
            ...
            <input type="radio" id="pp_settle_iche" name="pp_settle_case" value="계좌이체" <?php echo $checked; ?>><label for="pp_settle_iche" class="payment-select-box iche_icon"><?php echo $escrow_title; ?><?php echo $default['de_pg_service'] == 'toss' ? '퀵계좌이체' :'계좌이체'; ?></label>
            <?php $checked = ''; } ?>
