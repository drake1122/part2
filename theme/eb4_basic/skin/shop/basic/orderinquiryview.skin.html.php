                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($od['od_cash']) { ?>
                                    <a href="javascript:;" onclick="<?php echo $cash_receipt_script; ?>" class="btn-e btn-e-dark btn-e-sm">현금영수증 확인하기</a>
                                    <?php } else if (shop_is_taxsave($od)) { ?>
                                    <a href="javascript:;" onclick="window.open('<?php echo G5_SHOP_URL; ?>/taxsave.php?od_id=<?php echo $od_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');" class="btn-e btn-e-dark btn-e-sm">현금영수증 발급하기</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php } ?>
