...
<div class="shop-event">
    ...
    <div id="sev_himg" class="sev_img m-b-40"><img src="<?php echo G5_DATA_URL.'/event/'.$ev_id.'_h'; ?>" class="img-fluid" alt="image"></div>
    <?php } ?>
    ...
    <div id="sev_timg" class="sev_img m-t-40"><img src="<?php echo G5_DATA_URL.'/event/'.$ev_id.'_t'; ?>" class="img-fluid" alt="image"></div>
    <?php } ?>
</div>
