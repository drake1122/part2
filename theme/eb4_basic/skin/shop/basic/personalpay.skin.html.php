...
.shop-personalpay .personalpay-box-in {position:relative;border:1px solid #e5e5e5;padding:10px;background:#fff;border-radius:7px}
.shop-personalpay .personalpay-box .personalpay-img {margin-bottom:15px}
.shop-personalpay .personalpay-box .personalpay-img img {border-radius:5px}
            ...
            <div class="personalpay-box-pd">
                <div class="personalpay-box-in">
                    <div class="personalpay-img">
                        <a href="<?php echo $list[$i]['href']; ?>"><img src="<?php echo EYOOM_THEME_SHOP_SKIN_URL; ?>/img/personal.jpg" class="img-fluid" alt="image"></a>
                    </div>
