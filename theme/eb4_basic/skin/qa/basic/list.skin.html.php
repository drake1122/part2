...
.qa-list .ql-list .bl-photo {display:inline-block;margin-right:2px}
.qa-list .ql-list .bl-photo img {width:19px;height:19px;border-radius:50%}
.qa-list .ql-list .bl-photo .bl-user-icon {font-size:.9375rem}
