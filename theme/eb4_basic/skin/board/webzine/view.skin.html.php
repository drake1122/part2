...
.board-view .board-view-info .info-box-top .bl-photo {display:inline-block;margin-right:2px}
.board-view .board-view-info .info-box-top .bl-photo img {width:19px;height:19px}
.board-view .board-view-info .info-box-top .view-nick {margin-right:5px}
.board-view .board-view-info .info-box-top .view-nick .sv_wrap > a {font-weight:400}
.board-view .board-view-info .info-box-top .view-lv-icon {display:inline-block;margin-right:3px}
.board-view .board-view-info .info-box-top .btn-mbmemo {font-size:.8125rem;color:#c5c5c5}
.board-view .board-view-info .info-box-top .btn-mbmemo i {color:#757575;margin-left:5px}
...
.board-view .board-view-star .collapse-rating-result-panel .bl-photo {display:inline-block;margin-right:2px}
.board-view .board-view-star .collapse-rating-result-panel .bl-photo img {width:19px;height:19px}
...
.board-view .board-view-good-btn .board-view-act-gng .act-gng-btn {position:relative;overflow:hidden;width:80px;height:80px;border:1px solid #d5d5d5;border-radius:7px;background:#fff;display:inline-block;white-space:nowrap;vertical-align:baseline;text-align:center}
...
.board-view .board-view-good-member .bl-photo {display:inline-block;margin-right:2px}
.board-view .board-view-good-member .bl-photo img {width:19px;height:19px}
...
<article class="board-view">
    ...
    <div class="board-view-info">
        ...
        <div class="view-info-box" <?php if($config['cf_use_member_icon']) { ?>style="margin-left:60px"<?php } ?>>
            <div class="info-box-top">
                ...
                <?php if ($lv['gnu_icon']) { ?>
                <span class="view-lv-icon"><img src="<?php echo $lv['gnu_icon']; ?>" alt="레벨"></span>
                <?php } ?>
                <?php if ($lv['eyoom_icon']) { ?>
                <span class="view-lv-icon"><img src="<?php echo $lv['eyoom_icon']; ?>" alt="레벨"></span>
                <?php } ?>
    ...
    <div class="board-view-atc" id="view_good_nogood">
        ...
        <div id="wrfixed" class="text-center m-b-10">
            <a href="javascript:void(0);" id="bo_wrfixed" class="btn-e btn-e-dark">게시물 <?php echo $eyoom_board['bo_wrfixed_date']; ?>일간 상단노출 (<?php echo number_format($eyoom_board['bo_wrfixed_point']); ?>포인트 소모)</a>
        </div>
        <script>
        $(function() {
