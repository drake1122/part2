...
.board-webzine .webzine-item .webzine-img-box-in {position:relative;overflow:hidden;border-radius:7px}
...
.board-webzine .webzine-item .webzine-info .bl-photo {display:inline-block;margin-right:2px}
.board-webzine .webzine-item .webzine-info .bl-photo img {width:19px;height:19px}
.board-webzine .webzine-item .webzine-info .bl-photo .webzine-user-icon i {font-size:.9375rem;color:#252525}
