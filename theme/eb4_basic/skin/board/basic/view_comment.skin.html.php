...
.view-comment .view-comment-heading {font-size:1.25rem;margin-bottom:30px}
...
.view-comment .view-comment-item .view-comment-write-box {margin-left:15px}
...
.view-comment .comment-name .bl-photo {display:inline-block;margin-right:2px}
.view-comment .comment-name .bl-photo img {width:19px;height:19px}
.view-comment .comment-item-info {position:relative;padding:10px 20px 10px 70px;margin-bottom:15px;border:1px solid #eaeaea;background-color:#fafafa;border-top-right-radius:7px;border-bottom-right-radius:7px}
.view-comment .comment-item-info.bg-author {border-color:#beceff;background-color:#eef3ff}
...
.view-comment .comment-item-info .btn-mbmemo {font-size:.8125rem;color:#c5c5c5;margin-left:5px}
.view-comment .comment-item-info .btn-mbmemo i {color:#757575;margin-left:5px}
...
.view-comment .comment-btn-wrap {position:relative;text-align:right;height:20px;margin-top:15px}
.view-comment .comment-btn-wrap .comment-btn-right {position:absolute;top:0;right:0}
.view-comment .comment-btn-wrap .comment-btn {position:relative;float:left;padding:0 10px;height:20px;line-height:20px;cursor:pointer;font-size:.9375rem;font-weight:500;color:#555;margin-left:1px}
.view-comment .comment-btn-wrap .comment-btn:hover {color:#000;text-decoration:underline}
.view-comment .comment-item-body-pn .comment-item-info {padding-left:10px}
.view-comment-write {position:relative;margin-bottom:40px}
.comment-area .comment-write-heading {position:relative;font-size:1.25rem;padding:20px 0 15px}
.comment-area .comment-write-heading .cmt-point-info-btn {position:absolute;top:24px;right:0;font-size:.875rem;color:#555}
.comment-area .comment-write-heading .cmt-point-info-btn:hover {color:#000}
.comment-area .comment-write-wrap {position:relative}
.comment-area .comment-write {border:1px solid #d5d5d5;border-radius:7px;margin-bottom:20px}
.comment-area .comment-write .comment-write-option {position:relative;border-bottom:1px solid #d5d5d5}
.comment-area .comment-write .comment-write-option .option-btn-wrap {padding:15px}
.comment-area .comment-write .comment-write-option .option-btn-wrap .float-start {display:flex;align-items:center}
.comment-area .comment-write .comment-write-option .option-btn-wrap .float-start a {margin-right:15px;font-size:.9375rem;color:#555}
.comment-area .comment-write .comment-write-option .option-btn-wrap .float-start a span {margin-left:7px}
.comment-area .comment-write .comment-write-option .option-btn-wrap .float-end a {color:#555}
.comment-area .comment-write .comment-write-option .option-btn-wrap .float-start a:hover, .comment-area .comment-write .comment-write-option .option-btn-wrap .float-end a:hover {color:#000}
.comment-area .comment-write .comment-write-option .option-btn-wrap .float-end i {font-size:1.25rem}
...
.comment-area .comment-write .comment-write-option .comment-collapse-box label {margin-bottom:5px}
.comment-area .comment-write .comment-write-option .comment-collapse-box .btn-e-input {padding:5px 16px}
.comment-area .comment-write .comment-write-footer {position:relative;padding:15px;color:#959595;font-size:.8125rem;display:flex;align-items:center;justify-content:space-between}
.comment-area .comment-write .comment-write-footer .cwf-ul {display:flex;align-items:center}
.comment-area .comment-write .comment-write-footer .cwf-li {margin-right:20px}
.comment-area .comment-write .comment-write-footer .cwf-li .label {margin-bottom:0;margin-right:10px}
.comment-area .comment-write .comment-write-footer .cwf-li .input {margin-bottom:0}
.comment-area .comment-write .comment-write-footer .cwf-li .input input {width:200px}
.comment-area #modal_comment_video_note .table-list-eb .table thead>tr>th {text-align:left}
.comment-area .view-comment-more {text-align:center;border-top:1px solid #e5e5e5;padding-top:30px;margin-bottom:40px}
.comment-area .eyoom-form .textarea {margin-bottom:0}
.comment-area .eyoom-form .textarea textarea {border:1px solid transparent;padding:15px}
.comment-area .eyoom-form .textarea textarea:focus {border:1px solid transparent !important}
.comment-area .eyoom-form .textarea textarea::placeholder {color:#b5b5b5;word-break:keep-all}
...
@media (max-width:991px) {
    .comment-area .comment-write .comment-write-footer.no-member {display:block;align-items:inherit;justify-content:inherit}
    .comment-area .comment-write .comment-write-footer.no-member .cwf-ul {display:block;align-items:inherit;margin-left:-5px;margin-right:-5px}
    .comment-area .comment-write .comment-write-footer.no-member .cwf-ul:after {content:"";display:block;clear:both}
    .comment-area .comment-write .comment-write-footer.no-member .cwf-li {float:left;width:50%;margin-right:0;margin-bottom:10px;padding:0 5px}
    .comment-area .comment-write .comment-write-footer.no-member .cwf-li .label {margin-right:0}
    .comment-area .comment-write .comment-write-footer.no-member .cwf-li .input input {width:100%}
    .comment-area .comment-write .comment-write-footer.no-member .comment-write-submit {text-align:center}
}
@media (max-width:767px) {
    ...
    .comment-area .comment-write .comment-write-option .option-btn-wrap .float-start a {margin-right:25px}
    .comment-area .comment-write .comment-write-option .option-btn-wrap .float-start a span {display:none}
    .comment-area .comment-write .comment-write-option .option-btn-wrap .float-start a i {font-size:1.125rem}
    .comment-area .comment-write .comment-write-option .option-btn-wrap .float-end i {font-size:1.125rem}
    .comment-area .eyoom-form .textarea textarea::placeholder {font-size:.8125rem}
}
</style>
...
<div class="comment-area">
    ...
    <div class="view-comment">
        <h4 class="view-comment-heading"><strong>댓글목록<span class="text-deep-orange m-l-15"><i class="far fa-comment-dots m-r-5"></i><?php echo number_format($view['wr_comment']); ?></span></strong></h4>
                ...
                <?php } ?>
                    <div class="comment-item-info<?php if ($cmt[$i]['mb_id'] && $cmt[$i]['mb_id'] == $view['mb_id']) { ?> bg-author<?php } ?>">
                        <div class="m-t-3">
                            ...
                            <span class="comment-lv-icon"><img src="<?php echo $cmt[$i]['gnu_icon']; ?>" alt="레벨"></span>
                            <?php } ?>
                            <?php if ($cmt[$i]['eyoom_icon']) { ?>
                            <span class="comment-lv-icon"><img src="<?php echo $cmt[$i]['eyoom_icon']; ?>" alt="레벨"></span>
                            <?php } ?>
                        ...
                        <div class="comment-file-wrap">
                            <?php
                                ...
                                foreach ($cmtfile as $k => $cmt_file) {
                                    ...
                                    $ext = strtolower(pathinfo($cmt_file['source'], PATHINFO_EXTENSION));
                    ...
                    <div class="comment-btn-wrap">
                        ...
                        <div class="comment-btn-right">
                            ...
                            <a href="<?php echo $cmt[$i]['c_reply_href']; ?>" onclick="comment_box('<?php echo $cmt[$i]['comment_id']; ?><?php if ($cmt[$i]['is_cmt_best']) { ?>_<?php echo $cmt[$i]['cmt_depth']; ?><?php } ?>', 'c'); return false;" class="comment-btn">댓글</a>
                            <?php } ?>
                            ...
                            <a href="<?php echo $cmt[$i]['c_good_href']; ?>" id="goodcmt_button_<?php echo $cmt[$i]['comment_id']; ?>" class="goodcmt_button comment-btn" title="추천"><i class="far fa-thumbs-up"></i> <strong class="board-cmt-act-good"><?php if ($cmt[$i]['good']) { ?><span class="text-blue"><?php echo $cmt[$i]['good']; ?></span><?php } else { ?><span class="text-light-gray">0</span><?php }  ?></strong></a>
                            <?php } ?>
    ...
    <div id="view-comment-write" class="view-comment-write">
        <form name="fviewcomment" id="fviewcomment" action="<?php echo G5_BBS_URL; ?>/write_comment_update.php" onsubmit="return fviewcomment_submit(this);" method="post" autocomplete="off" class="eyoom-form view-comment-write-box" enctype="multipart/form-data">
            ...
            <h4 class="comment-write-heading">
                ...
                <a href="javascript:void(0);" class="cmt-point-info-btn" data-bs-toggle="modal" data-bs-target=".cmt-point-info-modal"><i class="fas fa-info-circle"></i> 댓글 포인트 안내</a>
                <?php } ?>
            </h4>
            <div class="comment-write-wrap">
                ...
                <div class="comment-write">
                    <div id="comment_option" class="comment-write-option">
                        <div class="option-btn-wrap clearfix">
                            <div class="float-start">
                                ...
                                <a class="comment-option-btn" data-bs-toggle="collapse" href="#collapse-file-cm" title="첨부파일"><i class="fas fa-paperclip"></i><span>첨부파일</span></a>
                                <?php } ?>
                                <?php if ($eyoom_board['bo_use_addon_video'] == '1') { ?>
                                <a class="comment-option-btn" data-bs-toggle="collapse" href="#collapse-video-cm" title="동영상"><i class="fab fa-youtube"></i><span>동영상</span></a>
                                <?php } ?>
                                <?php if ($eyoom_board['bo_use_addon_soundcloud'] == '1') { ?>
                                <a class="comment-option-btn" data-bs-toggle="collapse" href="#collapse-sound-cm" title="사운드클라우드"><i class="fab fa-soundcloud"></i><span>사운드클라우드</span></a>
                                <?php } ?>
                                <?php if ($eyoom_board['bo_use_addon_map'] == '1') { ?>
                                <a class="comment-option-btn" data-bs-toggle="collapse" href="#collapse-map-cm" title="지도"><i class="fas fa-map-marker-alt"></i><span>지도</span></a>
                                <?php } ?>
                                <?php if ($eyoom_board['bo_use_addon_coding'] == '1') { ?>
                                <a class="comment-option-btn" data-bs-toggle="collapse" href="#collapse-code-cm" title="코드"><i class="fas fa-code"></i><span>코드</span></a>
                                <?php } ?>
                            </div>
                            <?php if ($eyoom_board['bo_use_addon_emoticon'] == '1') { ?>
                            <div class="float-end">
                                <a class="comment-option-btn emoticon" data-vbtype="iframe" title="이모티콘" href="<?php echo EYOOM_CORE_URL; ?>/board/emoticon.php"><i class="far fa-smile"></i></a>
                            </div>
                            <?php } ?>
                        </div>
                        <?php if ($eyoom_board['bo_use_addon_cmtfile'] == '1') { ?>
                    ...
                    <label class="textarea textarea-resizable">
                        ...
                        <textarea rows="7" id="wr_content" name="wr_content" maxlength="10000" required placeholder="댓글은 자신을 나타내는 얼굴입니다. 무분별한 댓글, 욕설, 비방 등을 삼가하여 주세요." <?php if ($comment_min || $comment_max) { ?>onkeyup="check_byte('wr_content', 'char_count');"<?php }  ?>><?php echo $c_wr_content; ?></textarea>
                    ...
                    <div class="comment-write-footer <?php if (!$is_member) { ?>no-member<?php } ?>">
                        <div class="cwf-ul">
                            <?php if (!$is_member) { ?>
                            <div class="cwf-li">
                                <label class="input required-mark">
                                    <input type="text" name="wr_name" value="<?php echo get_cookie('ck_sns_name'); ?>" id="wr_name" required size="5" maxLength="20" placeholder="이름">
                                </label>
                            </div>
                            <div class="cwf-li">
                                <label class="input required-mark">
                                    <input type="password" name="wr_password" id="wr_password" required size="10" maxLength="20" placeholder="비밀번호">
                                </label>
                            </div>
                            <?php } ?>
                            <div class="cwf-li">
                        ...
                        <div class="comment-write-submit">
                            <button type="submit" id="btn_submit" class="btn-e btn-e-xlg btn-e-navy width-120px" value="댓글등록">댓글등록</button>
                        </div>
                    </div>
                </div>
                <?php if (!$is_member) { ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <?php if ($eyoom_board['bo_firstcmt_point'] > 0) { ?>
                    <div class="m-b-20">
                        <h5 class="f-s-17r f-w-600 m-b-10"><i class="far fa-comment-dots m-r-7"></i>첫댓글 포인트</h5>
                        <div class="point-info-box">
                            <?php if ($eyoom_board['bo_firstcmt_point_type'] == 1) { ?>
                            <p>첫 댓글을 작성하는 회원에게 최대 <span class="text-blue"><?php echo $eyoom_board['bo_firstcmt_point']; ?><?php echo $levelset['gnu_name']; ?> 이내에서 랜덤으로 첫댓글<?php echo $levelset['gnu_name']; ?></span>를 지급합니다.</p>
                            <?php } else { ?>
                            <p>첫 댓글을 작성하는 회원에게 <span class="text-blue"><?php echo $eyoom_board['bo_firstcmt_point']; ?><?php echo $levelset['gnu_name']; ?></span>를 첫댓글<?php echo $levelset['gnu_name']; ?>로 지급합니다.</p>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
                <?php if ($eyoom_board['bo_bomb_point'] > 0) { ?>
                    <div class="m-b-20">
                        <h5 class="f-s-17r f-w-600 m-b-10"><i class="fas fa-bomb m-r-7"></i>지뢰제거 포인트</h5>
                        <div class="point-info-box">
                            <p>지뢰폭탄이 총<span class="text-blue"><?php echo number_format($eyoom_board['bo_bomb_point_limit']); ?></span>개 매설되어 있습니다.</p>
                            <?php if ($eyoom_board['bo_bomb_point_type'] == 1) { ?>
                            <p>댓글을 작성하여 지뢰폭탄을 발견하면 최대 <span class="text-blue"><?php echo $eyoom_board['bo_bomb_point']; ?><?php echo $levelset['gnu_name']; ?> 이내에서 랜덤</span>으로 지뢰제거 보상<?php echo $levelset['gnu_name']; ?>로 지급합니다.</p>
                            <?php } else { ?>
                            <p>댓글을 작성하여 지뢰폭탄을 발견하면 <span class="text-blue"><?php echo $eyoom_board['bo_bomb_point']; ?><?php echo $levelset['gnu_name']; ?></span>를 지뢰제거 보상<?php echo $levelset['gnu_name']; ?>로 지급합니다.</p>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
                <?php if ($eyoom_board['bo_lucky_point'] > 0) { ?>
                    <div class="m-b-20">
                        <h5 class="f-s-17r f-w-600 m-b-10"><i class="far fa-hand-peace m-r-7"></i>행운 포인트</h5>
                        <div class="point-info-box">
                            <?php if ($eyoom_board['bo_lucky_point_type'] == 1) { ?>
                            <p>댓글을 작성하면 <span class="text-blue"><?php echo ceil(($eyoom_board['bo_lucky_point_ratio']/100)*100); ?>% 확률</span>로 최대 <span class="text-blue"><?php echo $eyoom_board['bo_lucky_point']; ?><?php echo $levelset['gnu_name']; ?> 이내에서 랜덤으로 행운의<?php echo $levelset['gnu_name']; ?></span>를 지급합니다.</p>
                            <?php } else { ?>
                            <p>댓글을 작성하면 <span class="text-blue"><?php echo ceil(($eyoom_board['bo_lucky_point_ratio']/100)*100); ?>% 확률</span>로 <span class="text-blue"><?php echo $eyoom_board['bo_lucky_point']; ?><?php echo $levelset['gnu_name']; ?></span>를 행운의<?php echo $levelset['gnu_name']; ?>로 지급합니다.</p>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
